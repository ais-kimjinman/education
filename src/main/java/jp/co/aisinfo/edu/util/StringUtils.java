...
public class StringUtils {
	...
	/**
	 * 半角英数字 → 全角英数字に置換する。 原理は、置換対象文字列 sSrc から1文字づつ取り出して sHan に該当する文字があったら、
	 * その文字が何文字目にあるか取得して、sZen から同じ文字目から文字を 取ると、全角にすり返るという方法。 例) sSrc = "ab1";
	 * 1番目の文字 "a" は、sHanの36文字目なので、sZenの36文字目は、"ａ"で、置換 2番目の文字 "b"
	 * は、sHanの37文字目なので、sZenの37文字目は、"ｂ"で、置換 3番目の文字 "1"
